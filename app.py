...
class Venue(db.Model):
    ...
    shows=db.relationship('Show', backref='get_venue',lazy='dynamic')
...
class Artist(db.Model):
    ...
    image_link = db.Column(db.String(500))
    facebook_link = db.Column(db.String(120))
    shows=db.relationship('Show', backref='get_artists',lazy='dynamic')
...
class Show(db.Model):
    ...
    venueid = db.Column(db.Integer, db.ForeignKey('venues.id'))
  ...
  # TODO: replace with real venue data from the venues table, using venue_id
    ...
    for show in venue.shows:
        ...
        if show in upcoming_shows:
            data[0]["upcoming_shows"].append({"artist_id":show.get_artists.id,"artist_name":show.get_artists.name,"artist_image_link":show.get_artists.image_link,'start_time':show.start_time})
            data[0]["upcoming_shows_count"]=len(data[0]["upcoming_shows"])

        else:
            data[0]["past_shows"].append({"artist_id":show.get_artists.id,"artist_name":show.get_artists.name,"artist_image_link":show.get_artists.image_link,'start_time':show.start_time})
